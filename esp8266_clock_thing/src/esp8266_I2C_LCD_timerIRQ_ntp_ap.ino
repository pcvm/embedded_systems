...
char ssid[] = "my_wifi_ssid";             // network SSID (name)
char pass[] = "my_wifi_password";   // network password
...
void handleUpdate() 
{
  ...
  clear_lcd_row(2); lcd.print(' '); lcd.print(pwd);
  clear_lcd_row(3); lcd.print("Rebooting...");
  server.send(200, "text/html", "<p> <h1>Thank you!</h1>");
  // save config data then call ESP.reset()
}
